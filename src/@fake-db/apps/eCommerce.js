  ...
  products: [
    {
      ...
      brand: 'VicTsing',
      price: 10.99,
      image: require('@src/assets/images/pages/eCommerce/th.png').default,
    ...
    },
    {
      ...
      brand: 'Google',
      price: 129.29,
      image: require('@src/assets/images/pages/eCommerce/th-_5_.png').default,
      hasFreeShipping: true,
      rating: 4,
    ...
    },
    {
      ...
      brand: 'OneOdio',
      price: 49.99,
      image: require('@src/assets/images/pages/eCommerce/th-_4_.png').default,
      hasFreeShipping: true,
      rating: 3,
    ...
    },
    {
      ...
      brand: 'Apple',
      price: 999.99,
      image: require('@src/assets/images/pages/eCommerce/th-_3_.png').default,
      hasFreeShipping: true,
      rating: 4,
    ...
    },
    {
      ...
      brand: 'Apple',
      price: 669.99,
      image: require('@src/assets/images/pages/eCommerce/th-_2_.png').default,
      hasFreeShipping: true,
      rating: 5,
