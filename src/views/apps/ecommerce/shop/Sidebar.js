            ...
            <CardBody>
              <div className='multi-range-price'>
                ...
                <ul className='list-unstyled price-range'>
                  ...
                  <li>
                    <CustomInput id='10-dollars-below' name='price-range-radio' type='radio' label='Available' />
                  </li>
                  <li>
                    <CustomInput id='10-100-dollars' name='price-range-radio' type='radio' label='unavailable' />
                  </li>
              ...
              {/* <div id='product-categories'>
                <h6 className='filter-title'>monitor</h6>
